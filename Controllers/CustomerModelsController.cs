...
namespace MVC_Assignment.Controllers
{
    ...
    {
        private readonly MVC_AssignmentContext _context;

        public CustomerModelsController(MVC_AssignmentContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CustomerID,CustomerName,Age")] CustomerModel customerModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("CustomerID,CustomerName,Age")] CustomerModel customerModel)
        {
